...
export function AboutSection() {
  return (
    <section id="about" className="py-16 sm:py-20 bg-white dark:bg-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <ScrollFadeIn delay={100}>
            <div className="bg-tobie-50 dark:bg-tobie-900/30 border border-tobie-100 dark:border-tobie-800 p-6 card-hover">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  <Phone className="h-4 w-4 text-tobie-500 dark:text-tobie-400" />
                  <a
                    href="tel:8008905420"
                    className="text-tobie-600 dark:text-tobie-400 font-medium hover:underline"
                  >
                    800-890-5420
                  </a>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <ExternalLink className="h-4 w-4 text-tobie-500 dark:text-tobie-400" />
                  <a
          ...
          <ScrollFadeIn delay={200}>
            <div className="bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 p-6 card-hover">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex-shrink-0 w-10 h-10 bg-gray-700 dark:bg-slate-600 flex items-center justify-center">
