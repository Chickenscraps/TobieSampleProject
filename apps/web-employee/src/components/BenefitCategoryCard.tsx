...
export function BenefitCategoryCard({ category }: BenefitCategoryCardProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 flex flex-col overflow-hidden">
      ...
      <div className="px-5 pt-5 pb-0">
        <div className="flex items-start gap-3">
          <div className="flex-shrink-0 w-10 h-10 bg-tobie-50 dark:bg-tobie-900/30 flex items-center justify-center">
            <IconComponent className="h-5 w-5 text-tobie-600 dark:text-tobie-400" />
          </div>
      ...
      {hasExpandableContent && (
        <>
          ...
          >
            <div className="px-5 pb-3">
              ...
              {category.employerPaid && (
                <div className="mb-3 px-2.5 py-2 bg-accent-50 dark:bg-accent-dark/10 border border-accent-200 dark:border-accent-700">
              ...
              {category.links && category.links.length > 0 && (
                <div className="flex flex-wrap gap-3 pt-2 border-t border-gray-100 dark:border-slate-700">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 px-5 py-2.5 text-xs font-medium text-tobie-600 dark:text-tobie-400 hover:text-tobie-700 dark:hover:text-tobie-300 hover:bg-tobie-50 dark:hover:bg-tobie-900/30 border-t border-gray-100 dark:border-slate-700 transition-colors mt-auto"
          >
