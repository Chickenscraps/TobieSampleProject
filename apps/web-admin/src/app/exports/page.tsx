    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">Export chat transcripts for review and compliance.</p>
        </div>
        <button
          onClick={() => setShowForm(!showForm)}
          className="inline-flex items-center gap-2 px-4 py-2 bg-tobie-600 text-white text-sm font-medium rounded-lg hover:bg-tobie-700 transition-colors"
        >
